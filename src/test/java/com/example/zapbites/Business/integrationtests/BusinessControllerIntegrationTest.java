package com.example.zapbites.Business.integrationtests;
...
public class BusinessControllerIntegrationTest {
    ...
    void getAll() throws Exception {
        var expectedResult = objectMapper.readValue(TestHelper.readJsonFile("/Testfiles/business_list.json"), List.class); //objectMapper gets a String representation of the .json with TestHelper.readJsonFile() method
    ...
    void getById() throws Exception {
        var expectedResult = objectMapper.readValue(TestHelper.readJsonFile("/Testfiles/get_by_id_3.json"), Business.class);
    ...
    void updateById() throws Exception {
        var requestBody = TestHelper.readJsonFile("/Testfiles/update_Business_with_id_1_request.json");
        var responseBody = TestHelper.readJsonFile("/Testfiles/update_Business_with_id_1_response.json");
    ...
    void createBusiness() throws Exception {
        var requestBody = TestHelper.readJsonFile("/Testfiles/created_business_request.json");
        var responseBody = TestHelper.readJsonFile("/Testfiles/created_business_response.json");
    ...
    void deleteAnExistingBusiness() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete("/business/3")).andExpect(status().isNoContent());
    }
}